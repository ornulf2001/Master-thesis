classdef MHEclass_KF_Update_old
    ...
    methods
        function obj = MHEclass_KF_Update_old(N, Ac, Bc, C,Q,R,M, x0,P0, dt,options)
        ...
        function obj=setupOptimizationProblem(obj)
            ...
            cost_Q_block = kron(eye(obj.N_MHE),obj.Q); %Stage costs for process noise, w
            cost_R_block= kron(eye(obj.N_MHE+1),obj.R); %stage costs for measurement noise, v
        ...
        function obj = initialGuessPropegation(obj)
            ...
            obj.P(obj.nStates+1 : obj.nStates+obj.nMeasurements, 2) = obj.C * x_propagated;
